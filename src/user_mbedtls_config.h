...
// Modes
#define MBEDTLS_SSL_CLI_C  // MQTT TLS client
#if HTTP_USE_TLS
#define MBEDTLS_SSL_SRV_C  // HTTPS web server (adds ~15-30KB ROM; enable only when needed)
#else
...
#if HTTP_USE_TLS
#define MBEDTLS_KEY_EXCHANGE_ECDHE_ECDSA_ENABLED  // for HTTPS server with EC cert
#else
